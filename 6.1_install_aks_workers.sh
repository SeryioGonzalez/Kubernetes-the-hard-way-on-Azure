...
do
	...
	ssh -o StrictHostKeyChecking=no $vmUser@${nicIp} "chmod 777 /home/$vmUser/$workerInstallScriptName; /home/$vmUser/$workerInstallScriptName $thisWorkerPodsCidr $podsCidr"
